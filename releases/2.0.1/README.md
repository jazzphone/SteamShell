# SteamShell 2.0.1 — self-contained release bundle

This directory is the immutable source lock for SteamShell 2.0.1 and its
...
compiles and version-checks the helper (2.0.1.1), then the companion (2.0.1.0),
embeds both, and verifies the main executable reports 2.0.1.0. Each step runs the
