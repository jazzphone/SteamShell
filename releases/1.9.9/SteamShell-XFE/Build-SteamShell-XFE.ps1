...
if ($compilerProcess.ExitCode -ne 0 -or -not $outputIsFresh) {
    ...
    throw (
        ...
        $compilerProcess.ExitCode + "). " + $outputState)
}
$outputVersion = (Get-Item -LiteralPath $OutputPath).VersionInfo.FileVersion
if ($outputVersion -ne "1.9.9.0") {
    throw "SteamShell-XFE version verification failed. Expected 1.9.9.0; found '$outputVersion'."
}
Write-Host "Verified SteamShell-XFE version: $outputVersion"
