...
The active tree is the locked **1.7.3** source with settings schema 12. Its
frozen checkpoint is `releases/1.7.3/`, taken deliberately as a revert point
immediately before the Quick Menu rendering rewrite.
