# SteamShell 1.7.7 Working-Tree Acceptance Test Checklist

The working tree is 1.7.7. The last locked source snapshot is
`releases/1.7.7/`.
...
- Run `..\Run-SteamShellValidation.cmd`. Confirm both sources parse, both static
...
- Confirm missing current options and `[SteamShell] SettingsSchemaVersion=16` are added.
