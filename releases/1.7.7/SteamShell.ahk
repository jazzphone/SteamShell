...
global SteamShellVersion := "1.7.7"
...
global CurrentSettingsSchemaVersion := 16
...
[SteamShell]
SettingsSchemaVersion=16                                   ; Internal schema used for safe settings upgrades
...
ShellOwnedWindowVisible() {
    ...
    global SetupAssistantGui, HealthCheckGui, QuickMenuLayoutGui
    if QuickMenuVisible
        return true
    for _, guiRef in [
...
SettingsEditorControllerActive() {
    ...
    global SetupAssistantGui, HealthCheckGui, QuickMenuLayoutGui, LiveLogGui
