...
if ($helperVersion -ne "2.0.1.1") {
    throw "SteamShell-Helper version verification failed. Expected 2.0.1.1; found '$helperVersion'."
}
...
if ($xfeEmbedVersion -ne "2.0.1.0") {
    throw (
        "SteamShell-XFE version verification failed. Expected 2.0.1.0; " +
...
if ($mainVersion -ne "2.0.1.0") {
    throw "SteamShell version verification failed. Expected 2.0.1.0; found '$mainVersion'."
}
