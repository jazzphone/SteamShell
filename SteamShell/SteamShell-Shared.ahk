    ...
    static table := Map(
        ...
        "Startup & Splash", [
            ...
            Map("product", "standalone", "type", "path",
                ...
                "prompt", "Select Steam.exe", "filter", "Programs (*.exe)",
            ...
            Map("product", "standalone", "type", "path",
                ...
                "label", "Startup video",
                "prompt", "Select a startup video", "filter", "Video Files (*.mp4; *.mkv; *.webm; *.wmv; *.avi)",
                "default", ""),
            Map("product", "standalone", "type", "path",
                "section", "Splash", "key", "MpvPath",
                "label", "MPV executable",
                "prompt", "Select mpv.exe", "filter", "Programs (*.exe)",
                "default", ""),
            Map("product", "standalone", "type", "checkbox",
        ...
        "Focus & Windows", [
            ...
            Map("product", "standalone", "type", "checkbox",
                ...
                "default", "true"),
            Map("product", "standalone", "type", "mappedchoice",
                "section", "GameForegroundAssist", "key", "GameMinScoreToActivate",
                "label", "Foreground sensitivity",
                "choices", ["Responsive (55)", "Balanced (60)", "Conservative (70)"], "values", ["55", "60", "70"],
                "default", "55"),
            Map("product", "standalone", "type", "checkbox",
