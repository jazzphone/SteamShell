...
Assert-True (
    ...
    $source -match 'AppVersion\s*:=\s*"2\.0\.1"' -and
    $buildScript -match 'SteamShell-XFE version verification failed.*?2\.0\.1\.0' -and
    ...
    "SteamShell-XFE 2.0.1 version metadata is inconsistent.")
