...
- The **combined Frame Limit row** (Off · 30 · 40 · 60 · 90 · 120 · Custom), the
  conditional Custom FPS row with escalating step, and **Save Limit to Profile**.
...
The active tree is the locked **1.7.1** source with settings schema 10 — nothing
in it adds or retires an INI key. Its frozen checkpoint is `releases/1.7.1/`;
`releases/1.7.0/`, `releases/1.6.0/`, `releases/1.5.0/`, `releases/XFE-0.1.14/`
and `releases/XFE-0.1.15/` remain unchanged.
...
All of the above is locked at `releases/XFE-0.1.15/`. The earlier
`releases/XFE-0.1.14/` snapshot is untouched.
